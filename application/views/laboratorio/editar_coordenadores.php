...
<?php else: ?>
  ...
  <div class="row">
    <div class="col s12">
      <p class="grey-text flow-text">Editar coordenador(es) de "<?php echo $laboratorio[0]->nome_lab; ?>"</p>
    </div>
  </div>
      ...
      <table class="striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="<?php echo base_url('laboratorio/deletar_coordenador_laboratorio/'.$laboratorio[0]->id_laboratorio.'/'.$row->id_pessoa); ?>" class="btn-flat red-text"><i class="material-icons left">delete</i>Remover</a></td>
          </tr>
          <?php  endforeach; ?>
        </tbody>
  ...
  <?php echo form_open('laboratorio/editar_coordenadores/'.$laboratorio[0]->id_laboratorio); ?>
