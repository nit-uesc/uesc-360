...
<?php else: ?>
    ...
    <ul class="collapsible z-depth-0" data-collapsible="accordion">
        ...
        <li>
            <a href="<?php echo base_url('laboratorio/gerenciar_normas_regulamentos_laboratorio/' . $laboratorio[0]->id_laboratorio); ?>"><div class="collapsible-header"><i class="material-icons">&#xE415;</i>Normas e Regulamentos</div></a>
        </li>
