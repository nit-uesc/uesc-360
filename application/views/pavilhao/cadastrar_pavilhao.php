<div class="row">
    <div class="col s12">
        <h4 class="grey-text">Cadastro de pavilhão</h4>
        ...
        <div class="col s12 m10 offset-m1 l8 offset-l2 center">
            ...
            <br>
            <br>
            <a href="<?php echo base_url('pavilhao/cadastrar_pavilhao'); ?>" class="btn green darken-3">Efetuar novo cadastro</a>
            </div>
        </div>
        </div>
        ...
        <div class="col s12 m10 offset-m1 l8 offset-l2 center">
            ...
            <br>
            <br>
            <a href="<?php echo base_url('pavilhao/cadastrar_pavilhao'); ?>" class="btn green darken-3">Tentar novamente</a>
            </div>
        </div>
        </div>
        ...
        <?php echo form_open('pavilhao/cadastrar_pavilhao'); ?>
            <div class="row">
